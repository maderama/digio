...
public class ProgrammingTask {
    public static void main(String[] args) {
        var file = "programming-task-example-data.log";
        HashMap<String, Integer> urls = new HashMap<>();
        HashMap<String, Integer> ipAddresses = new HashMap<>();
        extractIpAddressesAndUrls(file, urls, ipAddresses);
    ...
    public static void extractIpAddressesAndUrls(String file, HashMap<String, Integer> urls, HashMap<String, Integer> ipAddresses) {
        try {
            FileInputStream fstream = new FileInputStream(file);
            String strLine;
            var reader = new BufferedReader(new InputStreamReader(fstream));
    ...
    public static HashMap<String, Integer> extractIpAddresses(HashMap<String, Integer> ipAddresses, String strLine) {
    ...
    public static HashMap<String, Integer> extractUrls(HashMap<String, Integer> urls, String strLine) {
